...
if(isset($_POST['submitQuiz'])) {
    ...
    if($check < 1) {
        ...
        if($answerInsert = mysqli_query($con, $query)) {
            ...
            header("Location: http://localhost/login2/check_result.php?subject='$subject'");    
            exit(); 
        }
        else
        {
            header("Location: http://localhost/login2/quizhomepage.php");
            exit(); 
        }
    }
    else
    {
        ...
        header("Location: http://localhost/login2/quizhomepage.php?message='$message'");
        exit(); 
    }    
